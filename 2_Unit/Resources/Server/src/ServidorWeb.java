		...
		class Manejador extends Thread
		{
			...
			public void run()
			{
				try{
                                        ...
                                        while((n = dis.read()) > 1)
                                        {
                                            String linea = new String(byteArray, 0, n);
                                        }
                                        */
					...
					System.out.println("Datos: "+line+"\r\n\r\n");
                                        ...
                                        //Si no incluye ningun "?" entonces no mandaron parámetros
                                        //Recordando: GET /cosa.php?p1=v1&p2=v2... HTTP/1.0
					if(line.indexOf("?")==-1)
					{
						getArch(line);
						...
						System.out.println(FileName);
                                        ...
                                        //Caso de que si traiga parámetros la petición
			...
			public void SendA(String fileName,Socket sc)
			{
				...
				try{
					...
					//sendHeader();
					FileNameInputStream f = new FileInputStream(fileName);
					int x = 0;
