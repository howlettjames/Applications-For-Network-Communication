...
#include <string.h>
#include <stdio.h>
#include <stdlib.h>//exit/home/james/Documents/REDESII/STREAM_SOCKETS/2_Envia
    ...
    if (p == NULL)  {
	  ...
	  for(;;){  
	    int cd,enviados=0;
  	   ...
  	   // f1= fdopen(cd,"w+"); 
      //Socket linger sirve para que se espere 30 seg para que se puedan enviar todos los datos antes de que cierre
